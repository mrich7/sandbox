...
class PR2ARServo(object):
    def __init__(self, ar_topic):              #topic changed so that they won't overlap
        self.ar_sub = rospy.Subscriber('ar_tag_pose', AlvarMarkers, self.ar_sub)   #changed to use Alvar markers instead of ar pose markers
